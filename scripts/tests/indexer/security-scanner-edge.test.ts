...
const PATHS_FAMILY_TWINS: ReadonlyArray<{
  ...
  {
    // SMI-6441 Wave 1 L1: the generated weak-password lexicon module. Same
    // convention as the four hand-written twins above, even though this
    // pair is machine-generated by scripts/gen-weak-password-lexicon.mjs —
    // L1 catches a hand edit to just one twin; L3 (audit-standards.mjs)
    // catches drift from the generator's own source-of-truth inputs.
    label: 'security-scanner-edge.weak-passwords.ts',
    deno: resolve(REPO_ROOT, 'supabase/functions/_shared/security-scanner-edge.weak-passwords.ts'),
    node: resolve(REPO_ROOT, 'scripts/indexer/_shared/security-scanner-edge.weak-passwords.ts'),
    denoModuleLine: '@module _shared/security-scanner-edge.weak-passwords',
    nodeModuleLine:
