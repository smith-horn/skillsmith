...
#
# SMI-5650 (Wave 1 + Wave 2) alias-scope tmpfs / native-module named-volume
# tests were split into the sibling enumerate-compose-mounts-smi5650.test.sh
# per CLAUDE.md's 500-line guidance — see that file's header for details.
