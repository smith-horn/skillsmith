// E51: UD25 gate C against UD24 alone and against a first-probe threshold, plus stuck-clock and 0n stubs.
...
if (!/exp8|^\/tmp\/e51|^\/work|^\/exp\/e51/.test(BASE)) throw new Error('unsafe base')
