...
Reusable templates for common documentation and development tasks.

## Documents

| Template | Purpose |
|----------|---------|
| [skill-template.md](skill-template.md) | Template for creating new Claude Code skills |
...
Copy the appropriate template and fill in the placeholders for your use case.
