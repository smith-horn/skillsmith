...
const RECOVERY_SUGGESTIONS_MAP: Record<LicenseErrorCode, RecoverySuggestion[]> = {
  [LICENSE_ERROR_CODES.LICENSE_EXPIRED]: [
    {
      ...
      actionUrl: 'https://skillsmith.io/renew',
    ...
    },
    {
      ...
      actionUrl: 'https://skillsmith.io/support',
      autoRecoverable: false,
    },
  ],
  ...
  [LICENSE_ERROR_CODES.LICENSE_NOT_FOUND]: [
    ...
    },
    {
      ...
      actionUrl: 'https://skillsmith.io/pricing',
      autoRecoverable: false,
  ...
  [LICENSE_ERROR_CODES.FEATURE_NOT_AVAILABLE]: [
    {
      ...
      actionUrl: 'https://skillsmith.io/upgrade',
      autoRecoverable: false,
      estimatedTime: '5-10 minutes',
    },
    {
      ...
      actionUrl: 'https://skillsmith.io/contact-sales',
      autoRecoverable: false,
    },
  ],
