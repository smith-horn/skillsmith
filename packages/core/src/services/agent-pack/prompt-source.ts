...
export const OPERATING_PARAGRAPHS: readonly string[] = [
 ...
 */
export const TRUST_CLAUSES: readonly TrustClause[] = [
  {
...
export const PAYWALL_PRINCIPLES: readonly string[] = [
...
export const UNDO_PARAGRAPHS: readonly string[] = [
...
export const WILL_NOT: readonly string[] = [
