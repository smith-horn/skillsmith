...
describe('Error Handling', () => {
  describe('SkillsmithError', () => {
    it('should create error with code and message', () => {
      const error = new SkillsmithError(ErrorCodes.SKILL_NOT_FOUND, 'Skill xyz not found')
  ...
  describe('createErrorResponse', () => {
    it('should handle SkillsmithError', () => {
      const error = new SkillsmithError(ErrorCodes.SKILL_NOT_FOUND, 'Not found')
  ...
  describe('withErrorBoundary', () => {
    ...
    it('should pass through SkillsmithError unchanged', async () => {
      const handler = async () => {
        throw new SkillsmithError(ErrorCodes.SKILL_NOT_FOUND, 'Not found')
      }
      const wrapped = withErrorBoundary(handler)
