 ...
 *
 * Member-management coverage (removeTeamMember, setTeamMemberGithubUsername,
 * list_team_members_with_profile row-shape) lives in the sibling
 * team-invitations.member-management.test.ts (split for the 500-line gate,
 * SMI-5589).
 */
